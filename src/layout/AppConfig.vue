    ...
    <Sidebar v-model:visible="layoutState.configSidebarVisible.value" position="right" class="w-full sm:w-18rem">
        <template v-if="!simple">
            ...
            <div class="flex flex-wrap row-gap-3">
                ...
                <div class="flex align-items-center gap-2 w-6">
                    <RadioButton name="menuMode" value="slim" v-model="layoutConfig.menuMode.value" inputId="mode3">
                    </RadioButton>
                    <label for="mode3">Slim</label>
                </div>
                <div class="flex align-items-center gap-2 w-6 pl-2">
                    <RadioButton name="menuMode" value="slim-plus" v-model="layoutConfig.menuMode.value" inputId="mode4">
                    </RadioButton>
        ...
        <div class="flex">
            <div class="field-radiobutton flex-auto">
                <RadioButton name="colorScheme" value="light" v-model="colorScheme" id="theme3"
                    @change="changeColorScheme('light')"></RadioButton>
                <label for="theme3">Light</label>
            </div>

            <div class="field-radiobutton flex-auto">
                <RadioButton name="colorScheme" value="dark" v-model="colorScheme" id="theme1"
        ...
        <template v-if="!simple">
            ...
            <div class="field-radiobutton">
                <RadioButton name="menuTheme" value="colorScheme" v-model="menuTheme" inputId="menutheme-colorscheme"
                    @change="changeLayoutTheme('colorScheme')"></RadioButton>
                <label for="menutheme-colorscheme">Color Scheme</label>
            </div>
            <div class="field-radiobutton">
                <RadioButton name="menuTheme" value="primaryColor" v-model="menuTheme" inputId="menutheme-primarycolor"
                    @change="changeLayoutTheme('primaryColor')" :disabled="layoutConfig.colorScheme.value === 'dark'">
                </RadioButton>
        ...
        <div class="flex flex-wrap gap-3">
            <div v-for="(theme, i) in componentThemes" :key="i">
                <a :autoFocus="layoutConfig.theme === theme.name" @click="() => changeTheme(theme.name)"
